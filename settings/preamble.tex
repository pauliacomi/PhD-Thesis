...
\usepackage{setspace}       % easy line spacing
...
\usepackage[
    ...
    makeindex,                                      % makeindex compiler
    order=letter,                                   % order by letter
    toc,                                            % display in TOC
    nogroupskip,                                    % do not add groups
    nopostdot,                                      % no dot added
    nonumberlist,                                   % no page numbers
]{glossaries}
\usepackage{glossary-longbooktabs}

% make unit as a glossary column
\glsaddkey{unit}
...
% create new type of glossary for nomenclature
\newglossary[nlg]{notation}{not}{ntn}{Nomenclature}

% create new type of style for nomenclature
\newglossarystyle{nomenclatureunit}{%
    \setglossarystyle{long3col-booktabs}% base this style on the list style
    \renewenvironment{theglossary}{% Change the table type --> 3 columns
        \begin{longtable}{%
            cp{\glsdescwidth}>{\centering\arraybackslash}p{3cm}}}%
    {\end{longtable}}%
    %
    \renewcommand*{\glossaryheader}{%  Change the table header
    \toprule
    \bfseries \entryname & \bfseries \descriptionname & \bfseries Unit 
    \tabularnewline
    \midrule\endhead
    \bottomrule\endfoot
    }
