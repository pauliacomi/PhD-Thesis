...
\begin{figure}[htb]
    ...
    (b) \ce{H2O}, (c) \gls{MeOH} and (d) \gls{DMSO} leached samples.
...
\begin{figure}[p]
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-dmf-henry}}%
	\parbox[b]{0.88\linewidth}{%
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-dmf-porevol}}%
	\parbox[b]{0.88\linewidth}{%
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-h2o-henry}}%
	\parbox[b]{0.88\linewidth}{%
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-h2o-porevol}}%
	\parbox[b]{0.88\linewidth}{%
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-meoh-area}}%
	\parbox[b]{0.88\linewidth}{%
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-meoh-henry}}%
	\parbox[b]{0.88\linewidth}{%
	...
	\begin{subfigure}{0.33\linewidth}
	\parbox[c]{0.12\linewidth}{\caption{}%
		\label{def:fig:n2phys-meoh-porevol}}%
	\parbox[b]{0.88\linewidth}{%
	...
	and calculated pore volume (c, f, i ,l) for \gls{DMF}, \ce{H2O}, \gls{MeOH} and 
...
the solvents can be divided into protic (\ce{H2O}, \gls{MeOH}) and
...
and by the ability of intermediary \ce{OH-} ions to act as capping agents.
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.40\textwidth]{n2phys/dmso-tfa-hysteresis}
