...
(HPLC). In this study, \ce{^{1}H} NMR was used through the procedure
detailed in \autoref{appx:char:nmr} to qualitatively and 
quantitatively assess the presence of the capping agents in the 
UiO-66(Zr) samples.
