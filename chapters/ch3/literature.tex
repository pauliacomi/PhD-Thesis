...
\begin{figure}[htb]
	...
	\caption{
		...
		vacancy defects in the form of a) missing linker and b) missing cluster 
		substitutional defects such as c) mixed linker~\cite{buekenTacklingDefectConundrum2017}
