...
\todo{figure - example isotherms/catalysis/}
...
\begin{figure}[htb]
	...
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.85\linewidth}{%
			\includegraphics[width=\linewidth]{uio66-cluster}%
		}%
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		\parbox[c]{0.15\linewidth}{\caption{}%
		...
		\parbox[b]{0.85\linewidth}{%
			\includegraphics[width=\linewidth]{uio66-defect-linker}%
		}%
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		\parbox[c]{0.15\linewidth}{\caption{}%
		...
		\parbox[b]{0.85\linewidth}{%
			\includegraphics[width=\linewidth]{uio66-defect-cluster}%
		}%
	\end{subfigure}
...
on \ce{CO2 / N2} separation~\cite{thorntonDefectsMetalOrganic2016}.
