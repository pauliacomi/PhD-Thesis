...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{Takeda 5A dataset processing: (\protect\subref{calo:fgr:takeda-enth-fit})
	 an example of the empirical enthalpy fit model and (\protect\subref{calo:fgr:takeda-trends}) the calculated
