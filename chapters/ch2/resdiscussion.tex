...
\begin{figure}[ht]
	...
	\caption{Recorded data on the Takeda 5A sample, 
		(\protect\subref{calo:fgr:takeda-dataset}) the
		experimental dataset all recorded gases and 
		(\protect\subref{calo:fgr:takeda-enthalpy}) 
...
The adsorption of hydrocarbons is in accordance to their size, with
...
The initial enthalpy of adsorption

In order to The initial enthalpy of  is obtained through the \lstinline{pygaps.initial_enthalpy_comp()} function.
