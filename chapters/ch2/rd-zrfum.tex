...
isotherm at low pressure~\cite{furukawaWaterAdsorptionPorous2014},
...
Adsorption isotherms of nine probe gases were recorded at 
...
improvement may yield large energy savings. For reference, a 
currently patented pressure swing adsorption process considered 
promising for this separation uses Zeolite 4A as an adsorbent,
a material which has a selectivity for propylene in the range of 2--1
up to \SI{100}{\kilo\pascal}\cite{grandeAdsorptionPropanePropylene2002}.
The preference of propane over propylene is also highly desirable, as otherwise
propylene recovery has to be done during the blow-down phase
of a \gls{PSA}, which leads to low recovery rates 
or requires an energy inefficient vacuum process.
