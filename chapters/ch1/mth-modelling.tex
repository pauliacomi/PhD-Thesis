...
Figure~\ref{pyg:fgr:modelex}.\todo{change location}
...
\begin{itemize}
	...
	\item The adsorption energy of a molecule on the second and
	      higher layers
	      is the same and equals the condensation energy of the
	      adsorbent \(E_L\).
\end{itemize}

A particular surface percentage \(\theta_x\) is occupied with x
layers.
For each layer at equilibrium, the adsorption and desorption rates
must be equal.
We can then apply the Langmuir theory for each layer. \todo{better
	structure}
...
Since we are assuming that all layers beside the first have the same
properties,
...
Then we obtain the BET equation \todo{check equation}
...
\begin{figure}[p!]
	...
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/henry}}
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/langmuir}}
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/bet}}
	\end{subfigure}
	...
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/toth}}
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/quadratic}}
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/jseaton}}
	\end{subfigure}
	\\
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/temkin}}
	\end{subfigure}
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/virial}}
	\end{subfigure}3
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/wvst}}
	\end{subfigure}
	\\
	\begin{subfigure}{0.3\linewidth}
		...
		\parbox[b]{0.7\linewidth}{%
			...
			\includegraphics[width=\textwidth]{models/fhvst}}
	\end{subfigure}
