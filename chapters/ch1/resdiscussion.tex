...
nanoparticles~\cite{liControllableSynthesisMetal2013} (\SI{803}{\metre^2})
...
Some can be accounted for by synthesis method,
such as mecanosynthesis, and very high surface area 
