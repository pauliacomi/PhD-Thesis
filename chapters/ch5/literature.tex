...
two states is overcome. As the transition from the \textbf{cp} to the 
\textbf{op} state requires an activation energy, re-opening of the 
structure is only possible through complete structure loading.
If the system is in its \textbf{cp} state during adsorbate 
