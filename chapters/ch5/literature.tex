...
for the fundamental understanding of compliance and from the potential
...
The MOF is built through the \gls{SBU} approach, where the crystallographic
...
(\textbf{fcu}) net if the \gls{MOP} are considered as nodes and a trimodal 
...
This step corresponds to a reduction in the pore size of the MOF,
