...
MIL-100(Fe) is a \gls{MOF} which uses the benzene tricarboxilate (BTC) linker
...
The MIL-127(Fe) \gls{MOF} was made in the group of Christian Serre,
...
is described in detail in Appendix~\ref{appx:char:TGA}.
...
shaping process. The procedure is described in Appendix~\ref{appx:char:bulkdensity}
and Appendix~\ref{appx:char:truedensity}.
