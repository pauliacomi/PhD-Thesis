...
a protection effect on the reduction of \ce{Fe^3+} to
...
\ce{Fe^2+} state, exposing a naked metal site in the process.\cite{yoonControlledReducibilityMetalOrganic2010}
