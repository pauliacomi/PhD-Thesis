...
\begin{figure}[p!]
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{}\label{shaping:fgr:wateruio66}
    \end{subfigure}%
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{}\label{shaping:fgr:watermil100}
    \end{subfigure}%
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{}\label{shaping:fgr:watermil127}%
    \end{subfigure}%
...
\begin{figure}[p!]
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{}\label{shaping:fgr:methanoluio66}%
    \end{subfigure}%
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{}\label{shaping:fgr:methanolmil100}%
    \end{subfigure}%
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{}\label{shaping:fgr:methanolmil127}%
    \end{subfigure}%
