...
While no other significant features are visible on the isotherms themselves,
...
has increased, due to crystal aggregation. \todo{some micropore volumes missing + density}
