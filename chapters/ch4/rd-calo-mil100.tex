...
\begin{figure}[p]
	...
	\caption{\glspl{KPI} extracted from the MIL-100(Fe) adsorption dataset with
		...
		to the alumina shaped version on a mass and volume basis.
...
\begin{figure}[htb]
	...
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\linewidth]{calo/MIL-100(Fe)/propene-mass-basis-iso}
		\caption{}%
		\label{shaping:fig:mil100c3h6adsmol}
	\end{subfigure}%
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\linewidth]{calo/MIL-100(Fe)/propene-volume-basis-iso}
		\caption{}%
