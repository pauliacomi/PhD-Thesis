...
carbon monoxide and propylene (\autoref{fgr:shaping:mil100isotherms}).
...
The maximum loading differences (\autoref{fgr:shaping:analysismil100basis})
...
volume material basis in \autoref{fgr:shaping:mil100c3h6adsmol} and
\autoref{fgr:shaping:mil100c3h6adsvol} respectively.
...
\begin{figure}
	...
	\begin{subfigure}{\linewidth}
		\parbox[c]{0.1\linewidth}{\caption{}%
			\label{fgr:shaping:analysismil100henry}}%
	...
	\begin{subfigure}{\linewidth}
		\parbox[c]{0.1\linewidth}{\caption{}%
			\label{fgr:shaping:analysismil100enth}}%
		\parbox[b]{0.8\linewidth}{%
	...
	\begin{subfigure}{\linewidth}
		\parbox[c]{0.1\linewidth}{\caption{}%
			\label{fgr:shaping:analysismil100basis}}%
		\parbox[b]{0.8\linewidth}{%
	...
	\caption{KPIs extracted from the MIL-100(Fe) adsorption dataset with
		...
		respectively}%
	\label{fgr:shaping:analysismil100}
\end{figure}