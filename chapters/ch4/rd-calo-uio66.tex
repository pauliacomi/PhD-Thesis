...
\begin{figure}[htb]
	...
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\linewidth]{calo/UiO-66(Zr)/carbondioxide-mass-basis-iso}
		\caption{\ce{CO2} adsorption isotherms}%
		\label{shaping:fig:uio66co2ads}
	\end{subfigure}%
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\linewidth]{calo/UiO-66(Zr)/carbonmonoxide-mass-basis-iso}
