...
blocks of metal nodes and organic ``struts''. MOF synthesis can often
...
targets to be achieved. The energy-efficient capture of \ce{CO2} from
waste streams and at low partial pressures is of crucial interest 
from an environmental point of view, as \ce{CO2} is considered the 
...
the second generation of MOFs when the factors contributing to the strength
...
of MOFs lead to an unexpected conundrum, as hundreds of thousands
...
and scale-up of MOFs from a laboratory environment to 
...
discover new structure-property relationships in MOFs.
...
various factors on the ideal MOF structure.
...
in MOFs is studied. An alternative method for post-synthesis generation
...
Four solvents (DMF, \ce{H2O}, methanol and DMSO) are used in 
...
MOF industrialization, analysing the impact of shaping on the
original properties of the sample. Three topical MOFs, chosen
...
of DUT-49 a flexible MOF with a counterintuitive adsorption behaviour.
