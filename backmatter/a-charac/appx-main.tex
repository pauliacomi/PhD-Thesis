...
\gls{TGA} is a standard laboratory technique where the
...
\gls{TGA} experiments are carried out on approximately \SI{15}{\milli\gram} of 
...
glass vessels and settling the \glspl{MOF} inside. Powder materials are then added
...
Samples are activated \textit{in situ} by heating under vacuum. 
...
\section{High throughput isotherm measurement}\label{appx:char:highthroughput}
...
Two \gls{pXRD} machines have been used to record the diffraction patterns.
