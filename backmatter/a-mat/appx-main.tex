...
Then, \SI{896}{\gram} (\SI{2.8}{\mol}) of \ce{ZrOCl2*8H2O}
(98\%) and \SI{465}{\milli\liter} of 37\% \ce{HCl} 
(\SI{548}{\gram}, \SI{15}{\mol}) were added to the mixture. 
The molar ratio of the final \ce{ZrOCl2*8H2O/H2BDC/\gls{DMF}/HCl} 
...
for 1h. The final composition was \ce{Fe(NO3)3*9H2O}:0.67 
\gls{BTC}:\ce{$n$H2O} (n= 55–280). The reactant mixture was
...
\ce{C16N2O8H6} (\SI{3.3}{\gram}) in \gls{DMF} (\SI{415}{\milli\liter}) 
...
\ce{Fe(ClO4)3*6H2O} (\SI{3.27}{\gram}, \SI{9.2}{\milli\mol}) and 
\ce{C16N2O8H6} (\SI{3.3}{\gram}) in \gls{DMF}
