...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.42\linewidth}
        ...
        \label{appx:def:fgr:n2phys-h2o-fa-ht}
    \end{subfigure}%
    \begin{subfigure}{0.42\linewidth}
        \includegraphics[width=\textwidth]{n2phys/h2o-aa-ht}%
        \label{appx:def:fgr:n2phys-h2o-aa-ht}
    \end{subfigure}%
    
    \begin{subfigure}{0.42\linewidth}
        \includegraphics[width=\textwidth]{n2phys/h2o-tfa-ht}%
        \label{appx:def:fgr:n2phys-h2o-tfa-ht}
    \end{subfigure}%
