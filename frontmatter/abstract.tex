...
données publiées sur l'adsorption des matériaux poreux.
Apres, l'accent est mis sur l'utilisation de méthodes complémentaires pour étendre la 
méthodologie à haut débit. La mesure directe de l'enthalpie 
différentielle de l'adsorption en utilisant la microcalorimétrie
\textit{in situ} s'avère être un excellent moyen d'obtenir des 
informations supplémentaires sur la contribution
